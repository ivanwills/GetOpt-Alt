...
Getopt::Alt::CoockBook - Example usages of Getopt::Alt;
...
This all reduces the amount of boilder plate code needed in your scripts (of
...
Still have to work out how to implement this.
