...
sub get_bulk {
    return (
        ...
        , 'follow|f'
        , 'follow|l'
        , 'follow_links|followlinks|L'
        , 'followsymlinks'
        , 'force|f'
        , 'force|f|nonew'
        , 'force_title|forcetitle|f'
        , 'fork|f'
        , 'fork'
        , 'four|f'
        , 'front|trimfront|f=s'
        ...
        , 'sre_sub_no_matches|notcontains|notcontains|S=s@'
        , 'sre_whole|whole|w'
        , 'sre_words|words|W'
        , 'stdin|I'
        , 'stime|shorttime|s=i'
        ...
        , 'total|T'
        , 'type|t=s'
        , 'unicode_length|unicodelength|U'
        , 'unicode|u'
        , 'username|u=s'
        , 'username|U=s'
        , 'user|u=s'
